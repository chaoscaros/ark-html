    ...
    <el-col :span="24">
      <el-card style="max-width: 510px; justify-content: center; margin: auto">
        <el-tag style="font-size: var(--el-font-size-large)">
          <i class="el-icon-chat-round"></i> 公告
        </el-tag>
        <p>
          <span style="font-size: var(--el-font-size-small)" v-html="announcement"></span>
        </p>
      </el-card>
    </el-col>
  </el-row>
    ...
    <el-col :span="24">
      <el-card>
        ...
        <div class="card-footer">
          <el-button id="btncopy" type="primary" size="small" :data-clipboard-text="ck" auto @click="CopyCK">复制CK</el-button>
        </div>
      </el-card>
    </el-col>
  </el-row>
    ...
    <el-col :span="24">
      <el-card style="max-width: 510px; justify-content: center; margin: auto">
        ...
        <div class="card-body">
          ...
          <el-row class="demo-autocomplete">
            <el-col>
              <div style="width: 272px; width: 272px; height: 169px; margin: auto">
                <div id="captchaTip">
                  <img id="cpcImg" :src="imgUrl" @click="captchaTipclick" />
                  <div class="radio" v-for="item in pointlist" :key="item.tipIndex" v-bind:style="{
                      left: item.left + 'px',
                      top: item.top + 'px',
                    }">{{ item.tipIndex }}</div>
                </div>
          ...
          <el-button type="primary" size="medium" round @click="cap2click">确认</el-button>
        </div>
      </el-card>
    </el-col>
  </el-row>
        ...
        <div class="card-body">
          <el-tabs v-model="activeName">
            <el-tab-pane label="短信登陆" name="first">
              ...
              <el-row class="demo-autocomplete" v-show="uploadtype === 'xdd'">
                <el-col>
                  <el-input style="max-width: 260px" v-model="QQ" placeholder="QQ" prefix-icon="el-icon-chat-round" />
                </el-col>
              </el-row>
              <el-row class="demo-autocomplete">
                <el-col>
              ...
              <el-row class="demo-autocomplete">
                <el-col>
                  <el-input style="max-width: 260px" v-model="phone" placeholder="Phone" prefix-icon="el-icon-mobile-phone" />
                </el-col>
              </el-row>
              <el-row class="demo-autocomplete">
                <el-col>
            ...
            <el-tab-pane label="WSKEY" name="WSKEY" :disabled="uploadtype !== 'ql'">
              ...
              <el-row class="demo-autocomplete">
                <el-col>
                  <el-input style="max-width: 260px" v-model="wskey" placeholder="wskey" prefix-icon="el-icon-edit" />
                </el-col>
              </el-row>
              <el-row class="demo-autocomplete">
                <el-col>
              ...
              <el-row class="demo-autocomplete">
                <el-col>
                  <el-input v-model="remarks" style="max-width: 260px" placeholder="remarks" prefix-icon="el-icon-lock" />
                </el-col>
              </el-row>
              <el-row class="demo-autocomplete" v-show="uploadtype === 'ql'">
                <el-col>
            ...
            <el-tab-pane label="CK" name="CK">
              ...
              <el-row class="demo-autocomplete">
                <el-col>
                  <span class="elabe">CK</span>
                </el-col>
              </el-row>
              <el-row class="demo-autocomplete">
                <el-col>
                  <el-input style="max-width: 260px" v-model="cookie" placeholder="ck" prefix-icon="el-icon-edit" />
                </el-col>
              </el-row>
              <el-row class="demo-autocomplete">
                <el-col>
              ...
              <el-button type="primary" size="medium" @click="CKLogin">上传</el-button>
            </el-tab-pane>
          </el-tabs>
        </div>
      </el-card>
        ...
        verify: async function (arr, url) {
          ...
          if (VerifyCaptchadata.success) {
            ...
            if (VerifyCaptchadata.data.status == 666) {
              ...
              data.VsliderCaptcha.reset(VerifyCaptchadata.data.big, VerifyCaptchadata.data.small)
            } else {
              data.ShowCaptcha = false
              data.ShowMain = true
            }
        ...
        if (body.success == false && body.data.status == 666) {
          ...
          if (AutoCaptchadata.success) {
            ...
            if (AutoCaptchadata.data.captcha == 1) {
              data.VsliderCaptcha.reset(AutoCaptchadata.data.big, AutoCaptchadata.data.small)
            ...
            if (AutoCaptchadata.data.captcha == 2) {
              ...
              data.imgUrl2 = 'data:image/png;base64,' + AutoCaptchadata.data.small
            }
            data.ShowMain = false
            return false
          }
    ...
    const cap2click = async () => {
      ...
      if (VerifyCaptchadata2.success) {
        ...
        if (VerifyCaptchadata2.data.status == 666) {
          ...
          data.imgUrl2 = 'data:image/png;base64,' + VerifyCaptchadata2.data.small
        } else {
          data.ShowCaptcha2 = false
          data.ShowMain = true
